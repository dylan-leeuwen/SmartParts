...
// orders connection
$sql = "SELECT users.voornaam, users.achternaam, orders.buyerstotalpieces, orders.status, orders.plaats FROM orders INNER JOIN users ON orders.user_id = users.user_id LIMIT 5";
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php echo $totaltotalrevenue;?></h2>
...
<?php while ($orders = $resultorders->fetch_assoc()) {
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $orders["voornaam"] ." ". $orders["achternaam"] ?></td>
                                                <td><span><?php echo $orders["plaats"] ?></span></td>
                                                <td><span><?php echo $orders["buyerstotalpieces"]?></span></td>
                                                <td><span style="background-color: <?php echo $statuscolor?>" class="badge badge-success"><?php echo $orders["status"]?></span></td>
                                            </tr><?php } ?>
                                        </tbody>
                                    </table>
                                </div>
